...
- **Automated DAO Voting:** Users set predefined principles and preferences, and Davos ensures their votes align accordingly.
...
Davos follows a **hexagonal architecture** with three main components:
...
By leveraging **LLMs for analysis, KMS for security, and Monad for efficient execution**, Davos is a pioneering step towards **on-chain AI-driven governance**.
...
## Contributing
We welcome contributions! Feel free to open issues or submit pull requests to improve Davos.
